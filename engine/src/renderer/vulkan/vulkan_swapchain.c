...
void create(vulkan_context* context, UInt32 width, UInt32 height, vulkan_swapchain* out_swapchain);
...
void create(vulkan_context* context, UInt32 width, UInt32 height, vulkan_swapchain* swapchain) {
