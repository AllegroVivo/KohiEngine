...
KAPI Boolean input_is_key_up(keys key);
KAPI Boolean input_was_key_down(keys key);
KAPI Boolean input_was_key_up(keys key);

void input_process_key(keys key, Boolean pressed);

KAPI Boolean input_is_button_down(buttons button);
KAPI Boolean input_is_button_up(buttons button);
KAPI Boolean input_was_button_down(buttons button);
KAPI Boolean input_was_button_up(buttons button);
